...
function Dashboard() {
  return (
    <div className="space-y-6">
      ...
      {/* Customers Table */}
      <CustomersTable />
      <div class="border-t border-gray-300 text-center py-4 text-sm text-gray-600">© {new Date().getFullYear()} All Rights Reserved | Developed by Kunash Media Solutions</div>
    </div>
  );
}
